/* **************** LFD5435:5.4 s_18/lab_kprobes.c **************** */
/*
...
static int count_mod_timer = 0, count_del_timer = 0,
	count_del_timer_sync = 0, count_add_timer = 0;
...
MODULE_DESCRIPTION("LFD5435:5.4 s_18/lab_kprobes.c");
