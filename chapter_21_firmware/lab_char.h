...
#define MYDEV_NAME "custom_firmware"
...
static inline int __init my_generic_init(void)
{
	...
	my_dev = device_create(foo_class, NULL, first, NULL, "%s", "custom_firmware");
 ...
 * MODULE_DESCRIPTION("LFD5435:5.4 s_21/lab_char.h");
