/* **************** LFD5435:5.4 s_18/lab_miscdev.h **************** */
/*
 ...
 *
 */
#ifndef GENERIC_CHAR_H
#define GENERIC_CHAR_H
...
static int __init my_generic_init(void)
{
	...
	pr_info("MY_CMD_CONFIG value is %lu\n", MY_CMD_CONFIG);
	return 0;
}
 ...
 * MODULE_DESCRIPTION("LFD5435:5.4 s_18/lab_miscdev.h");
