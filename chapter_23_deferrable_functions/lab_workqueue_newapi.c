/* **************** LFD5435:5.4 s_23/lab_workqueue_newapi.c **************** */
/*
 ...
 */
/*
 * Deferred Functions (private work queue solution, new API)
 *
...
{
	pr_warn("new workq API does not appear until 2.6.36\n");
	return -1;
}
...
MODULE_DESCRIPTION("LFD5435:5.4 s_23/lab_workqueue_newapi.c");
