/* **************** LFD5435:5.4 s_23/lab_one_workqueue_dynamic.c **************** */
/*
...
{
	struct my_dat *data = kmalloc(sizeof(struct my_dat), GFP_ATOMIC);
...
MODULE_DESCRIPTION("LFD5435:5.4 s_23/lab_one_workqueue_dynamic.c");
