/* **************** LFD5435:5.4 s_23/lab_all_interrupt.h **************** */
/*
...
mycdrv_read(struct file *file, char __user *buf, size_t lbuf, loff_t *ppos)
{
	...
	if (bytes_to_do == 0)
		pr_warn("Reached end of the device on a read");
...
static int __init my_generic_init(void)
{
	...
	nevents = kmalloc_array(MAXIRQS, sizeof(atomic_t), GFP_KERNEL);
	get_irqs();
...
MODULE_DESCRIPTION("LFD5435:5.4 s_23/lab_all_interrupt.h");
